...
This paper analyzes international food prices looking at countries, food groups, currency, food measurements, inflation, and other data. The data for this analysis was collected by the United Nation's World Food Programme’s vulnerability analysis and is updated monthly. The dataset can be retrieved from [here](data.humdata.org/dataset/wfp-food-prices) 
------

#2. Exploretory Analysis and Data Cleaning {#Cleaninglink}
...
Countries that have a unstable inflation are Myramar and South Sudan. South Sudan instability is cause from the issues discussed above. As for Myanmar this is interensting because maize production has increased steadily since 2000 (https://knoema.com/atlas/Myanmar/topics/Agriculture/Crops-Production-Yield/Maize-yield).
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Countries that have a unstable inflation are Timor-Leste and Malawi. In recently year Timor-Leste has been effected greatly by climate change and population growth. In addition poor and unstable agricultural resources are previlent with ony 30% of arable land being used for cropping or in combination with animal grazing. (GOTL (2007) Government of Timor-Leste IV Constitutional Government Program 2007–2012. http://ageconsearch.umn.edu/bitstream/125077/2/2012AC%20Lopes%20CP.pdf). 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
The amount of insight that can be gained from this dataset is enormous. I decided to take a broad approach by combing the top foods and looking at their prices all over the world. More specifically in Africa because that is where the majority of my data came from. 

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
What was found from this broad approach is that price of food is greatly determined by natural resources. Wether that be the long rainy season or no rainy season at all. Also, politics play a huge roll in a countries food security. In this analysis, this meant civil war, but it is not limited to just that.
