...
```{r, fig.width=14, echo=FALSE, message=FALSE, warning=FALSE}
...
Latin_America_Caribbean_rice_price_matrix
  ```
  ```{r, echo=FALSE,fig.width=14, fig.height=16,message=FALSE, warning=FALSE}
...
Countr Price Matrixs
```{r, echo=FALSE,fig.width=14, message=FALSE, warning=FALSE}
#Middle_East_North_Africa_sorghum_price_matrix
