...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
The last analysis I will do for rice is the price to survive. Which is a price for a year's worth of rice which is equilin to 1000 calories of rice a day? The calculated that 1000 calories of rice are about 769.23076923 G.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Once again a vast majority of the data is from Sub-Saharan Africa. Also the extremely low prices in Latin America & The Caribbean. Which is interesting because sorghum production is not very large in this region. Though for this dataset the region is represented by one country, Honduras. Additionally, for the Middle East and North Africa, there is only data from one country, so the only true representation of a region is for Sub-Saharan Africa. 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
The next food for analysis is beans. Which similar to rice is a more international food soo there is much more diversity in the data.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Enormous insight can be gained from this dataset. I took a broad approach by combing the top foods and looking at their prices throughout the world. Africa had the majority of my data.
